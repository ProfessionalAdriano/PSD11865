...
BEGIN
    ...
    CURSOR CursorExtrato IS
      SELECT COD_EMPRESA,NUM_REGISTRO,DTA_FIM,DCR_PLANO,COD_PLANO,VLR_DQ,VLR_DR,VLR_DU,VLR_DV,
             VLR_EI,VLR_EG,VLR_RES3,VLR_RES4
    ...
    BEGIN
      ...
      LOOP
        ...
        FETCH CursorExtrato
          INTO COD_EMPRESA,NUM_REGISTRO,DTA_FIM,DCR_PLANO,COD_PLANO,DQ,DR,DU,DV,EI,EG,RES3,RES4;
        ...
        UPDATE att.fc_pre_tbl_base_extrat_ctb a
           SET a.VLR_BENEF_BD_PROP   = DQ,
               ...
               a.VLR_SLD_ADICIONAL   = RES3,
               a.VLR_BENEF_ADICIONAL = RES4
